...
export function renderRuleForm(draft, { canDelete = false } = {}) {
  ...
  return `<form id="tr-rule-form" class="tr-rule-editor">
    <label class="tr-field"><span class="tr-field-heading"><span>查找</span><span class="tr-meta">英文逗号或换行等价分隔；每项可用正则</span></span><textarea id="tr-find" data-rule-field="find" required maxlength="8000" rows="2" spellcheck="false" autocapitalize="off" autocorrect="off">${esc(draft.find)}</textarea></label>
